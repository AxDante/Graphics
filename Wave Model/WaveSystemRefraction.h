#ifndef WAVESYSTEMREFRACTION_H
#define WAVESYSTEMREFRACTION_H
...
class WaveSystemRefraction : public ParticleSystem
{
public:

	WaveSystemRefraction(int row, int column, float mass, float step);
	...
	int baseSpreadSpeed;
	int maxCenter = 35;
	float magnitudeReflectThreshold = 0.05;
	float waveDecayRate = 0.007;
