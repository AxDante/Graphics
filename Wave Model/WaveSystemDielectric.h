#ifndef WAVESYSTEMDIELECTRIC_H
#define WAVESYSTEMDIELECTRIC_H
...
class WaveSystemDielectric : public ParticleSystem
{
public:

	WaveSystemDielectric(int row, int column, float mass, float step);
