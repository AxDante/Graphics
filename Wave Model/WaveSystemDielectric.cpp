...
void WaveSystemDielectric::dragMotion() {
	return;
}


void WaveSystemDielectric::takeTimeStep()
{
	vector<Vector3f> f;
...
void WaveSystemDielectric::draw()
{
...
int WaveSystemDielectric::index(int cur_row, int cur_col, int tot_row, int tot_col) {
...
void WaveSystemDielectric::takeStep(float stepSize)
{
