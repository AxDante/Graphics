#ifndef WAVESYSTEMDIELECTRICNEW_H
#define WAVESYSTEMDIELECTRICNEW_H
...
class WaveSystemDielectricNew : public ParticleSystem
{
public:

	WaveSystemDielectricNew(int row, int column, float mass, float step);
	...
	vector< float > particleRefractionIndex;
	vector< int > sourceType;

	int baseSpreadSpeed;
	int maxCenter = 20;
	float magnitudeReflectThreshold = 0.02;
	float waveDecayRate = 0.03;
