...
void WaveSystemPoint::dragMotion() {
	return;
}


void WaveSystemPoint::takeTimeStep()
{
	vector<Vector3f> f;
...
int WaveSystemPoint::index(int cur_row, int cur_col, int tot_row, int tot_col) {
...
void WaveSystemPoint::takeStep(float stepSize)
{
