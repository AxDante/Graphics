#ifndef WAVESYSTEMWALLDRAW_H
#define WAVESYSTEMWALLDRAW_H
...
class WaveSystemWallDraw : public ParticleSystem
{
public:

	WaveSystemWallDraw(int row, int column, float mass, float step);
